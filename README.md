...
| `week_1.ipynb` | Original self-contained background, solvers, and convergence experiments |
| `week_1_external_solvers.ipynb` | Recommended Week 1 workflow using `ou_fd.py` and `ou_em.py` |
